...
public class Bogged extends AbstractSkeleton implements Shearable {
     ...
     */
    @Override
    protected AbstractArrow getArrow(ItemStack pArrowStack, float pVelocity, @Nullable ItemStack p_344869_) {
        AbstractArrow abstractarrow = super.getArrow(pArrowStack, pVelocity, p_344869_);
