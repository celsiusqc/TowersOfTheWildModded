...
public class Arrow extends AbstractArrow {
    ...
    public Arrow(Level pLevel, double pX, double pY, double pZ, ItemStack pPickupItemStack, @Nullable ItemStack p_345233_) {
        super(EntityType.ARROW, pX, pY, pZ, pLevel, pPickupItemStack, p_345233_);
        this.updateColor();
    }

    public Arrow(Level pLevel, LivingEntity pOwner, ItemStack pPickupItemStack, @Nullable ItemStack p_345461_) {
        super(EntityType.ARROW, pOwner, pLevel, pPickupItemStack, p_345461_);
        this.updateColor();
    }
