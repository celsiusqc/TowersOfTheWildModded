...
public class PanicGoal extends Goal {
    ...
    public PanicGoal(PathfinderMob pMob, double pSpeedModifier, TagKey<DamageType> p_350426_) {
        this(pMob, pSpeedModifier, p_350055_ -> p_350426_);
    }

    public PanicGoal(PathfinderMob pMob, double pSpeedModifier, Function<PathfinderMob, TagKey<DamageType>> p_350935_) {
        this.mob = pMob;
