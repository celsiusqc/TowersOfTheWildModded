...
public class DecoratedPotRenderer implements BlockEntityRenderer<DecoratedPotBlockEntity> {
    ...
    public void render(DecoratedPotBlockEntity pBlockEntity, float pPartialTick, PoseStack pPoseStack, MultiBufferSource pBuffer, int pPackedLight, int pPackedOverlay) {
        ...
        VertexConsumer vertexconsumer = Sheets.DECORATED_POT_BASE.buffer(pBuffer, RenderType::entitySolid);
        ...
        this.renderSide(this.frontSide, pPoseStack, pBuffer, pPackedLight, pPackedOverlay, getSideMaterial(potdecorations.front()));
        this.renderSide(this.backSide, pPoseStack, pBuffer, pPackedLight, pPackedOverlay, getSideMaterial(potdecorations.back()));
        this.renderSide(this.leftSide, pPoseStack, pBuffer, pPackedLight, pPackedOverlay, getSideMaterial(potdecorations.left()));
        this.renderSide(this.rightSide, pPoseStack, pBuffer, pPackedLight, pPackedOverlay, getSideMaterial(potdecorations.right()));
        pPoseStack.popPose();
    }
