...
public class WorldBorder {
    ...
    private boolean isWithinBounds(double pX, double pZ, double pOffset, double p_352943_) {
        return this.isWithinBounds(pX, pZ) && this.isWithinBounds(pOffset, p_352943_);
    }
