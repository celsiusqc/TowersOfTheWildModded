...
public final class ProjectileUtil {
    ...
    public static AbstractArrow getMobArrow(LivingEntity pShooter, ItemStack pArrowStack, float pVelocity, @Nullable ItemStack p_345078_) {
        ArrowItem arrowitem = (ArrowItem)(pArrowStack.getItem() instanceof ArrowItem ? pArrowStack.getItem() : Items.ARROW);
        AbstractArrow abstractarrow = arrowitem.createArrow(pShooter.level(), pArrowStack, pShooter, p_345078_);
