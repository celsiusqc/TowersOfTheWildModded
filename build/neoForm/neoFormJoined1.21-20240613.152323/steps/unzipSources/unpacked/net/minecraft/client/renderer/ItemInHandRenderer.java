...
public class ItemInHandRenderer {
    ...
    private void applyEatTransform(PoseStack pPoseStack, float pPartialTicks, HumanoidArm pHand, ItemStack pStack, Player p_346361_) {
        float f = (float)p_346361_.getUseItemRemainingTicks() - pPartialTicks + 1.0F;
        float f1 = f / (float)pStack.getUseDuration(p_346361_);
        if (f1 < 0.8F) {
