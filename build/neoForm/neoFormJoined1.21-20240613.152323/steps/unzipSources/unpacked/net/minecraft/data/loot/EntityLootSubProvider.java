...
public abstract class EntityLootSubProvider implements LootTableSubProvider {
    ...
    protected EntityLootSubProvider(FeatureFlagSet pEnabledFeatures, HolderLookup.Provider p_345284_) {
        this(pEnabledFeatures, pEnabledFeatures, p_345284_);
    }

    protected EntityLootSubProvider(FeatureFlagSet pAllowed, FeatureFlagSet pRequired, HolderLookup.Provider p_344819_) {
