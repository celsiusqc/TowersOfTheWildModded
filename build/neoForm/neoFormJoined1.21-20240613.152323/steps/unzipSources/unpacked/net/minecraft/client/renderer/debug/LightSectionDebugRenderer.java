...
public class LightSectionDebugRenderer implements DebugRenderer.SimpleDebugRenderer {
    ...
    private static void renderFace(
        ...
        LevelRenderer.renderFace(
            pPoseStack, pVertexConsumer, pFace, f, f1, f2, f + 16.0F, f1 + 16.0F, f2 + 16.0F, pColor.x(), pColor.y(), pColor.z(), pColor.w()
        );
    }
    ...
    private static void renderEdge(
        ...
        pVertexConsumer.addVertex(matrix4f, f, f1, f2).setColor(pColor.x(), pColor.y(), pColor.z(), 1.0F);
        pVertexConsumer.addVertex(matrix4f, f3, f4, f5).setColor(pColor.x(), pColor.y(), pColor.z(), 1.0F);
    }
