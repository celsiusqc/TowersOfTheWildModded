...
public abstract class AbstractSkeleton extends Monster implements RangedAttackMob {
     ...
     * Fires an arrow
     */
    protected AbstractArrow getArrow(ItemStack pArrowStack, float pVelocity, @Nullable ItemStack p_346155_) {
        return ProjectileUtil.getMobArrow(this, pArrowStack, pVelocity, p_346155_);
    }
